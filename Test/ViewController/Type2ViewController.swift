...
class Type2ViewController:UIViewController{
    ...
    // 4. Type2ViewController : viewDidLoad -> viewWillAppear -> viewDidAppear
    // 5. ViewController : viewDidDisappear
    // 6. Type2ViewController  종료 시. : viewWillDisappear->viewDidDisappear
